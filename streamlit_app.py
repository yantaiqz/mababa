...
# 初始化当前人物购物车
if st.session_state.char_key not in st.session_state.cart:
...
for row_idx in range(total_rows):
    ...
    for col_idx, item in enumerate(row_items):
        with cols[col_idx]:
            ...
            current_count = st.session_state.cart[c_key][item['id']]
